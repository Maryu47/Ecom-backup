            ...
            <div class="col-xl-12">
                <div class="relative_contect d-flex">
                    ...
                    <ul class="wsus__menu_item">
                        ...
                        <li><a class="{{setActive(['flash-sale'])}}" href="{{route('flash-sale')}}">Flash deals</a></li>
                    ...
                    <ul class="wsus__menu_item wsus__menu_item_right">
                        ...
                        <li><a href="{{route('admin.dashboard')}}">{{auth()->user()->name}}'s dashboard</a></li>
                        <li>
                        ...
                        <li><a href="{{route('vendor.dashboard')}}">{{auth()->user()->name}}'s dashboard</a></li>
                        @elseif (auth()->check() && auth()->user()->role == 'user')
                        <li><a href="{{route('user.dashboard')}}">{{auth()->user()->name}}'s dashboard</a></li>
                        @else
