        ...
        <div class="row">
            ...
            <div class="col-xl-7 col-md-7 col-lg-7">
                <div class="wsus__pro_details_text">
                    <a class="title" href="javascrpit:;">{{ $product->name }}</a>
                    @if ($product->qty > 0)
                        <p class="wsus__stock_area"><span class="in_stock">in stock</span> ({{ $product->qty }}
                            item)</p>
                    @elseif ($product->qty == 0)
                        <p class="wsus__stock_area"><span class="out_stock">out stock</span> ({{ $product->qty }}
                            item)</p>
                    @endif
                    ...
                    <form class="shopping-cart-form">
                        ...
                        <ul class="wsus__button_area">
                            ...
                            <li><a style="border: 1px solid gray; padding: 7px 10px; border-radius: 100%;" href="javascript:;" class="add_to_wishlist" data-id="{{$product->id}}"><i class="fal fa-heart"></i></a></li>
                            <li><a style="border: 1px solid gray; border-radius: 100%;" href="javascript:;" class="" data-bs-toggle="modal" data-bs-target="#exampleModal"><i class="far fa-comment"></i></a></li>
                        </ul>
                    </form>
