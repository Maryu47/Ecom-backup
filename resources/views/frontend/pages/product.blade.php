                                        ...
                                        <div class="col-xl-4 col-sm-6">
                                            <div class="wsus__product_item">
                                                ...
                                                <div class="wsus__product_details">
                                                    ...
                                                    <a class="wsus__pro_name" href="{{route('product-detail', $product->slug)}}">{{limitText($product->name,55)}}</a>
                                                    @if (checkDiscount($product))
                                                        <p class="wsus__price">
                                                            {{ $product->offer_price }}{{ $settings->currency_icon }}
                                                ...
                                                <div class="wsus__product_details">
                                                    ...
                                                    <ul class="wsus__single_pro_icon">
                                                        <form class="shopping-cart-form">
                                                            ...
                                                            <input name="qty" type="hidden" min="1"
                                                                max="100" value="1" />
                                                            <button type="submit" class="add_cart_two" href="#">Add to
                                                                cart</button>
                                                        </form>
                                                        <li><a href="" class="add_to_wishlist" data-id="{{$product->id}}"><i class="far fa-heart"></i></a></li>
                                                        {{-- <li><a href="#"><i class="far fa-random"></i></a> --}}
