                    ...
                    <div class="wsus__main_blog">
                        ...
                        <div class="wsus__share_blog">
                            ...
                            <ul>
                                ...
                                <li><a href="https://twitter.com/share?url={{url()->current()}}&text={{$blog->title}}"><i class="fab fa-twitter"></i></a></li>
                                <li><a href="https://www.linkedin.com/shareArticle?url={{url()->current()}}&title={{$blog->title}}&summary={{limitText($blog->description, 50)}}"><i class="fab fa-linkedin-in"></i></a></li>
                            </ul>
                        </div>
                                    ...
                                    <div class="wsus__single_blog wsus__single_blog_2">
                                        ...
                                        <div class="wsus__blog_text">
                                            ...
                                            <div class="wsus__blog_text_center">
                                                <a href="{{route('blog-details', $blogItem->slug)}}">{!!limitText($blogItem->title, 20)!!}</a>
                ...
                <div class="col-xxl-3 col-xl-4 col-lg-4">
                    <div class="wsus__blog_sidebar" id="sticky_sidebar">
                        ...
                        <div class="wsus__blog_post">
                            <h4>More Post</h4>
                            @foreach ($moreBlogs as $bItem)
                            <div class="wsus__blog_post_single">
                                <a href="{{route('blog-details', $bItem->slug)}}" class="wsus__blog_post_img">
                                    <img style="height: 71px;" src="{{asset($bItem->image)}}" alt="blog" class="imgofluid w-100">
                                </a>
                                <div class="wsus__blog_post_text">
                                    <a href="{{route('blog-details', $bItem->slug)}}">{!!limitText($bItem->title, 19)!!}</a>
                                    <p> <span>{{date('d M Y', strtotime($bItem->created_at))}}</span> {{count($bItem->comments)}} Comment </p>
                                </div>
                            </div>
                            @endforeach
                        </div>
