<div class="dashboard_sidebar">
    ...
    <ul class="dashboard_link">
      ...
      <li><a href="{{route('vendor.products.index')}}"><i class="fas fa-tachometer"></i>Product</a></li>
      <li><a href="{{route('vendor.reviews.index')}}"><i class="fas fa-tachometer"></i>Reviews</a></li>
