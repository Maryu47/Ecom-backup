    ...
    <aside id="sidebar-wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <ul class="dropdown-menu">
          <li class="{{setActive([
            'admin.blog-category.*'
          ])}}"><a class="nav-link" href="{{route('admin.blog-category.index')}}">Categories</a></li>
          <li class="{{setActive([
            'admin.blog.*'
          ])}}"><a class="nav-link" href="{{route('admin.blog.index')}}">Blog</a></li>
          <li class="{{setActive([
            'admin.blog-comments.index'
          ])}}"><a class="nav-link" href="{{route('admin.blog-comments.index')}}">Blog Comment</a></li>
        </ul>
      </li>
        ...
        <li class="dropdown {{ setActive([
          ...
          <ul class="dropdown-menu">
            ...
            <li class="{{setActive([
              'admin.admins-list.index'
            ])}}"><a class="nav-link" href="{{route('admin.admins-list.index')}}">Admin list</a></li>
            <li class="{{setActive([
              'admin.manage-user.index'
            ])}}"><a class="nav-link" href="{{route('admin.manage-user.index')}}">Manage user</a></li>
