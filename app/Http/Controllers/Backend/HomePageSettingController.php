...
class HomePageSettingController extends Controller
{
    ...
    public function updatePopularCategorySection(Request $request) {
        $request->validate([
            ...
            'cat_one.required' => 'Category one fill is required!',
            'cat_two.required' => 'Category two fill is required!',
            'cat_three.required' => 'Category three fill is required!',
            'cat_four.required' => 'Category four fill is required!',
        ]);
    ...
    public function updateProductSliderSectionOne(Request $request) {
        ...
        $request->validate([
            ...
            'cat_one.required' => 'Category fill is required!'
        ]);
        $data = [
                'category' => $request->cat_one,
                'sub_category' => $request->sub_cat_one,
    ...
    public function updateProductSliderSectionThree(Request $request) {
        ...
        $request->validate([
            ...
            'cat_one.required' => 'Category fill is required!',
            'cat_two.required' => 'Category fill is required!',
        ]);
